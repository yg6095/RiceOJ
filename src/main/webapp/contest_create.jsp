                        ...
                        <div class="form-group">
                            ...
                            <div class="input-group text-center">
                                <table class="table table-fixed" id="problemSet">
                                    <thead>
                                    <tr>
                                        <th width="10%"><a id="addBtn"><i class="icon icon-plus"></i></a></th>
                                        <th width="10%">#</th>
                                        <th width="10%">题号</th>
                                        <th width="40%">标题</th>
                                        <th width="30%">状态</th>
                            ...
                            <script>
                                ...
                                $("#addBtn").click(function () {
                                    ...
                                    const probNum = "<input type='search' id='search' class='form-control search-input probNum' autofocus=\"autofocus\" placeholder='题号'>"
                                    const probTitle = "<input type='text' class='form-control probTitle' placeholder='标题'>";
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    if (data["code"] != 0) {
                                        ...
                                        window.location.href = "${ptx}/contests.jsp";
                                    }
                                }, error: function (data) {
                                    showError(data);
                                }
